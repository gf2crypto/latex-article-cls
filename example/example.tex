...
%%%% gentium - шрифты гентиум
%%%% xcharter - шрифры XCharter
%%%% txmath - математический шрифт newtxmath
%%%% times - шрифты близкие к MS Word
\documentclass[colorthm, bib]{../civarticle}
...
\newpage
\thispagestyle{empty}  % Удаляем нумерацию страниц и убираем все
% колонтитулы
...
\letterTitle{% Суть документа
  З А Я В Л Е Н И Е
}

\vspace{3\bigskipamount}

\begin{spacing}{2} % Текст с расстоянием в 2 пункта
...
\letterDate % Ставим сегодняшнюю дату

\vspace{4\bigskipamount}

% Подпись
\sign{Доцент кафедры информационной безопасности ВМК МГУ имени
  М.В.Ломоносова, канд.физ.--мат.наук.}{И.И.Иванов}

\vspace{3\bigskipamount}

% Согласующая подпись
\sign[С О Г Л А С О В А Н О:]{Декан факультета вычислительной
  математики и кибернетики МГУ имени М.В.Ломоносова, академик}{А.А.Петров}
\newpage
